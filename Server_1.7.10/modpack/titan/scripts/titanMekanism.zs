#Metallurgic Infuser
mods.mekanism.Infuser.addRecipe("OBSIDIAN", 100, <customthings:item>, <customthings:item:2>);
...
#Crusher
mods.mekanism.Crusher.addRecipe(<minecraft:diamond_horse_armor>, <minecraft:diamond> * 5);